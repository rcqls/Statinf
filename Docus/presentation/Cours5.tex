...
\pgfsetendarrow{\pgfarrowto}
\pgfline{\pgfxy(\:{CqlsBeamer.where("diet:2.5,0.2","ex")})}{\pgfxy(\:{CqlsBeamer.where("diet:1.8,0.04","ex")})}}
\only<4-5>{
 
\pgfsetendarrow{\pgfarrowto}
\pgfline{\pgfxy(\:{CqlsBeamer.where("diet:2.5,0.2","ex")})}{\pgfxy(\:{CqlsBeamer.where("diet:2.5,0.005","ex")})}}
\only<6>{
...
\pgfsetendarrow{\pgfarrowto}
\pgfline{\pgfxy(\:{CqlsBeamer.where("diet:2.5,0.2","ex")})}{\pgfxy(\:{CqlsBeamer.where("diet:2.2,0.01","ex")})}}
\only<7>{
...
\pgfsetendarrow{\pgfarrowto}
\pgfline{\pgfxy(\:{CqlsBeamer.where("diet:2.5,0.2","ex")})}{\pgfxy(\:{CqlsBeamer.where("diet:2.2,0.01","ex")})}
\pgfline{\pgfxy(\:{CqlsBeamer.where("diet:1.9,0.3","ex")})}{\pgfxy(\:{CqlsBeamer.where("diet:1.75,0.065","ex")})}}
