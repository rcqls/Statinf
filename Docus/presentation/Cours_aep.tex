...
\only<1-3>{
\pgfputat{\pgfxy(0.5,1.2)}{\pgfbox[center,top]{\begin{minipage}{11cm}
{\small
$\begin{array}{l}
...
\only<1>{
\pgfputat{\pgfxy(0,-0.05)}{\pgfbox[left,bottom]{\pgfuseimage{quant}}}}
\only<2>{
\pgfputat{\pgfxy(0,-0.05)}{\pgfbox[left,bottom]{\pgfuseimage{quantNorm}}}}
\only<3>{
\pgfputat{\pgfxy(0,-0.05)}{\pgfbox[left,bottom]{\pgfuseimage{quantExpNorm}}}}
